const images = { 
    shape1: require("./shape-1.png").default,
    christina: require("./christina.png").default,
    shape2: require("./shape-2.png").default,
    shopping: require("./Vector.png").default,
    calender: require("./Vector1.png").default,
